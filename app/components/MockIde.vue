...
.ide::after {
  ...
  height: 240px;
  border-radius: 999px;
  background: rgba(215, 245, 107, 0.26);
  content: '';
  filter: blur(2px);
}
...
.files .active {
  background: rgba(215, 245, 107, 0.12);
  color: #fffaf0;
}
...
.highlight {
  border: 1px solid rgba(215, 245, 107, 0.24);
  border-radius: 14px;
  background: rgba(215, 245, 107, 0.1);
  color: var(--lime);
  padding: 10px;
}
