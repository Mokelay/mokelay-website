  ...
  zh: {
    ...
    auth: {
      ...
      form: {
        ...
        goRegister: '立即注册',
        goLogin: '去登录',
        oauthDivider: '或使用第三方继续',
        googleSubmit: '使用 Google 继续',
        githubSubmit: '使用 GitHub 继续',
        oauthErrors: {
          provider_denied: '第三方授权已取消。',
          invalid_state: '登录状态已过期，请重新尝试。',
          missing_code: '第三方登录缺少授权码，请重新尝试。',
          provider_failed: '第三方登录服务暂时不可用，请稍后重试。',
          email_unverified: '第三方账号邮箱未验证，暂时无法登录。',
          account_conflict: '账号绑定冲突，请使用邮箱密码登录后再处理。',
        },
  ...
  en: {
    ...
    auth: {
      ...
      form: {
        ...
        oauthErrors: {
          provider_denied: 'Third-party authorization was cancelled.',
          ...
          provider_failed: 'The third-party login service is unavailable. Please try again later.',
          email_unverified: 'The provider email is not verified, so it cannot be used to log in.',
          account_conflict: 'Account linking conflicted. Please log in with email first.',
        },
